        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button
              ...
              className="flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-all font-semibold text-sm text-gray-700 dark:text-gray-300"
            >
          ...
          <div className="relative mb-8 text-center">
            ...
            <span className="relative px-4 bg-white dark:bg-gray-950 text-xs text-gray-500 uppercase tracking-widest font-bold">or continue with email</span>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 dark:bg-gray-900 border border-transparent focus:border-indigo-500 focus:bg-white dark:focus:bg-gray-800 rounded-xl px-4 py-4 text-gray-900 dark:text-white outline-none transition-all shadow-sm"
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wide">Password</label>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="remember" className="ml-2 text-sm text-gray-600 dark:text-gray-400 font-medium cursor-pointer">Remember me for 30 days</label>
            </div>

            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold py-4 rounded-xl shadow-lg shadow-indigo-500/20 transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-70 flex items-center justify-center gap-2"
            >
              {isLoading ? (
          ...
          <p className="mt-8 text-center text-gray-600 dark:text-gray-400 font-medium">
            ...
            <Link to="/signup" className="text-indigo-600 hover:text-indigo-500 font-bold underline underline-offset-4">Sign up for free</Link>
          </p>
        </div>
      </div>
    </div>
